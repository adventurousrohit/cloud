            ...
            <div className="row align-items-center">
                <div className="col-lg-7 col-xl-6">
                    ...
                    <p className="mb-8 text-white max-text-40 text-opacity-75" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                        With over 20+ years of experience in web hosting,
                        our team is here to help 24/7/365.
                    </p>
                ...
                <div className="col-lg-5 col-xl-6 text-lg-end">
                    <img src="/img/support-hero-img.png" alt="image" className="img-fluid" data-sal="fade" data-sal-duration="1500" data-sal-delay="300" data-sal-easing="ease-in-out-sine"/>
                </div>
            </div>
        </div>
    </section>
