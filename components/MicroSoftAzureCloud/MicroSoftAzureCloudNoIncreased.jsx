        ...
        <div className="pb-60">
          <div className="container">
            <div className="row g-4 align-items-center">
              ...
              >
                <img
                  src="/Middle/Microsoft Azure Cloud (1).png"
                  alt="image"
                  className="img-fluid"
                />
              </div>
              <div className="col-lg-6">
                <div className="ps-lg-8 pe-xxl-12">
                  ...
                  <h3
                    ...
                    data-sal-easing="ease-in-out-sine"
                  >
                    Instant Deployment with Azure Cloud Hosting
                  </h3>
                  <p
                    data-sal="slide-up"
                    data-sal-duration="500"
                    ...
                    data-sal-easing="ease-in-out-sine"
                  >
                    Experience instant deployment with the most popular Azure
                    Hosting. CloudMinister ensures seamless setup, so your
                    business can start operating without delays.
                  </p>
