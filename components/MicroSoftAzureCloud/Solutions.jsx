...
import {microsoftAzureServices } from '../../utils/data';
...
const Solutions = () => {
  ...
  const getServicesForTab = (category) =>
    microsoftAzureServices.filter((service) => service.category === category);
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-xxl-10 text-center">
            ...
            >
              Experience the Why to Choose Microsoft Azure Hosting with Confidence
            </h2>
            <p
              data-sal="slide-up"
              data-sal-duration="500"
              ...
              data-sal-easing="ease-in-out-sine"
            >
              Whether you’re managing an only application or thousands across regions, CloudMinister’s Microsoft Azure Cloud Hosting services are your trusted partner from growth to success. Contact us now to experience the future of hosting and take your business to the next level in the industry.
            </p>
          </div>
        </div>
