        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            <p className="text-white text-center">
              We have three carefully constructed AWS Server Management plans
              for all your cPanel related requirements. Please review the plan
              details below and contact us if you need any assistance selecting
              your cPanel Server Management Plan.
            </p>
          </div>
        </div>
      </div>
