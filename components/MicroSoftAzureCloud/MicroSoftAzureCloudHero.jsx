          ...
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                ...
                <span className="text-success-new">Azure Cloud Hosting</span>{" "}
                Solutions
              </h3>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Empower your business with Azure Hosting: Scale up or out
                anytime, customize servers effortlessly, enjoy a simple
                management console with API control, and rely on 24/7
                personalized support for uninterrupted growth.
              </p>
              <div
            ...
            <div className="col-lg-5 col-xl-6 text-lg-end">
              <img
                src="/email/Microsoft Azure Cloud.png"
                alt="image"
                className="img-fluid"
                data-sal="fade"
                data-sal-duration="1500"
