        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                Take Charge of Your Hosting with{" "}
                <span className="text-success-new"> ISP Config</span> Server
                Management
              </h1>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Take full control of your hosting with ISP Config's intuitive
                server management. Simple task management, enhance efficiency,
                and manage servers securely—all from a user-friendly interface
                designed to streamline your hosting experience.
              </p>
              <div
