...
const pricingData = [
  {
    id: 1,
    title: "Starter ISPConfig Management",
    // price: '₹ 360.00/mo*',
    features: [
  ...
  {
    id: 2,
    title: "Plus ISPConfig Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro ISPConfig Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Choose Your Power: Compare ISP Config Plans Today
              </h2>
            </div>
            <p className="text-white text-center">
              Compare features across our comprehensive plans from the essential
              configurations for a new start-up to the advanced options for
              high-traffic websites. With our transparent pricing and expert
              support, managing your server has never been simpler and much more
              better.
            </p>
          </div>
        </div>
