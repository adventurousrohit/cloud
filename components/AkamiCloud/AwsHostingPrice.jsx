...
const pricingData = [
  {
    id: 1,
    title: 'Starter cPanel Management',
    price: '₹ 360.00/mo*',
    features: [
        ...
        { feature: '60 minute initial response for support Tickets.', enabled: false },
  ...
  },
  {
    ...
    features: [
        ...
        { feature: '30 minute initial response for support Tickets.', enabled: false },
        { feature: 'Extra Migration support (Paid)', enabled: false }, // Paid feature
  ...
  },
  {
    ...
    features: [
        ...
        { feature: 'Backup planning for disaster recovery', enabled: true },
        { feature: 'Installation and optimizing Firewall', enabled: true },
        { feature: '10 minute initial response for support Tickets.', enabled: true },
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8 col-xl-7 text-center" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
              <h2 className="text-white">Choose Your AWS Support Plan</h2>
            </div>
            <p className='text-white text-center'>We have three carefully constructed AWS Server Management plans for all your cPanel related requirements. Please review the plan details below and contact us if you need any assistance selecting your cPanel Server Management Plan.</p>
          </div>
        </div>
      </div>
      <div className="container">
      ...
      >
        <div className="card border-0 h-100 d-flex flex-column">
          <div className="card-body price-card-item-one position-relative overflow-hidden px-xl-7 py-xl-9 d-flex flex-column flex-grow-1">
            ...
            <small className='mt-2'>Our most affordable, single-domain hosting plan.</small>
            <div className="mt-5">
