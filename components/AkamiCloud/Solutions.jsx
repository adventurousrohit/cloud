...
import { AkamiServices} from '../../utils/data';
...
const Solutions = () => {
  ...
  const getServicesForTab = (category) =>
    AkamiServices.filter((service) => service.category === category);
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-xxl-10 text-center">
            ...
            >
            Streamlined Hosting Management with Akamai's Advanced Services
            </h2>
            <p
              data-sal="slide-up"
              data-sal-duration="500"
              ...
              data-sal-easing="ease-in-out-sine"
            >
            Effortless hosting with Akamai’s reliable, scalable, and secure services by CloudMinister.
            </p>
          </div>
        </div>
