...
const pricingData = [
  {
    id: 1,
    title: "Starter Google Cloud Management",
    // price: "₹ 360.00/mo*",
    features: [
  ...
  {
    id: 2,
    title: "Plus Google Cloud Management",
    // price: "₹ 360.00/mo*",
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro Google Cloud Management",
    // price: "₹ 360.00/mo*",
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Streamlined Google Cloud Services: Choose Your Perfect Plan
              </h2>
            </div>
            <p className="text-white text-center">
              Learn how to operate Google Cloud servers with ease using plans
              that are customized to your company's requirements. Enjoy
              scalable, secure, and affordable solutions that enable your cloud
              journey with ease, whether you're a startup or an established
              business.
            </p>
          </div>
        </div>
