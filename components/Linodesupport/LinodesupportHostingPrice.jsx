...
const pricingData = [
  {
    id: 1,
    title: "Starter Linodesupport Management",
    // price: '₹ 360.00/mo*',
    features: [
  ...
  {
    id: 2,
    title: "Plus Linodesupport Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro Linodesupport Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Choose Cloudminister for the Linode Server Management Plan
              </h2>
            </div>
            <p className="text-white text-center">
              We have three carefully constructed Linodesupport Server
              Management plans for all your Rackspace related requirements.
              Please review the plan details below and contact us if you need
              any assistance selecting your webmin Server Management Plan.
            </p>
          </div>
        </div>
      </div>
