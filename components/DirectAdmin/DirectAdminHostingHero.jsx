        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                Reliable and Secure{" "}
                <span className="text-success-new">Direct Admin</span> Server
                Management
              </h1>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Cloudminister manage Direct Admin, so you don't have to.
              </p>
              <div
              ...
              {/* <span className="d-block fs-14 text-white text-opacity-75 mt-2" data-sal="slide-up" data-sal-duration="1500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                ...
                <div className="col-lg-5 col-xl-6 text-lg-end">
                    <img src="/img/Direct Admin.png" alt="image" className="img-fluid" data-sal="fade" data-sal-duration="1500" data-sal-delay="300" data-sal-easing="ease-in-out-sine"/>
                </div>
            </div>
        </div>
      </section>
