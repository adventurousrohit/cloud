...
const pricingData = [
  {
    id: 1,
    title: "Starter Plesk Management",
    // price: '₹ 360.00/mo*',
    features: [
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Seamless Plesk Server Management Plans for Every Need
              </h2>
            </div>
            <p className="text-white text-center">
              Our professionally designed Plesk Server Management Plans assure
              perfect server management, security, and performance. For
              hassle-free hosting, we offer comprehensive Plesk Support Plans
              from a reliable server management company. Contact us now for
              quality Plesk Server Administration Services!
            </p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="card border-0 h-100 d-flex flex-column">
                ...
                <div className="mt-2 px-xl-7">
                  <h3 className="mb-5 fs-16" style={{paddingLeft:"10px"}}>Top Features</h3>
...
export default PleskHostingPrice;
