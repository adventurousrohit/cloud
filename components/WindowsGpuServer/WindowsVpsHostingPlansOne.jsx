...
const PriceCardWithTabs = ({ title, subtitle, pricingData }) => {
  ...
  const [selectedTab, setSelectedTab] = useState("Windows A100"); // Default to "India"
            ...
            <div className="row justify-content-center">
              <div className="col-xl-10">
                ...
                <TabList className="nav nav-pills justify-content-center mt-4" role="tablist">
                  {["Windows A100",  "Windows L40S", "Windows L4","Windows A30","Windows A40","Windows V100"].map((tabName) => (
                    <Tab
                      key={tabName}
