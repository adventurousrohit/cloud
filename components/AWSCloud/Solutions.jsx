...
import { AwsCloud } from '../../utils/data';
...
const Solutions = () => {
  ...
  const getServicesForTab = (category) =>
    AwsCloud.filter((service) => service.category === category);
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-xxl-12 text-center">
            ...
            >
             Boosting Your Business Performance – CloudMinister’s Optimized AWS Cloud Hosting
            </h2>
            <p
              data-sal="slide-up"
              data-sal-duration="500"
              ...
              data-sal-easing="ease-in-out-sine"
            >
           CloudMinister goes beyond simplifying AWS infrastructure by optimizing performance at the application layer. We offer real-time monitoring and advanced security controls, ensuring the smooth operation of your platforms and security from potential threats. Our expertise makes your online business thrive with the best performance within the AWS ecosystem.
            </p>
          </div>
        </div>
