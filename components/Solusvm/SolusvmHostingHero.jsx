          ...
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                ...
                <span className="text-success-new">SolusVM Server</span>{" "}
              ...
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Our SolusVM Server Management Services offer comprehensive
                solutions, including:
                <br />
                24x7 Monitoring <br />
                Expert Administration <br />
                Proactive Support
              </p>
              <div
