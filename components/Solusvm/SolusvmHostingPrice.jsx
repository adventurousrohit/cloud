...
const pricingData = [
  {
    id: 1,
    title: "Starter Solusvm Management",
    // price: '₹ 360.00/mo*',
    features: [
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                SolusVM Server Management Services at Unbeatable Prices
              </h2>
            </div>
            <p className="text-white text-center">
              Looking for reliable SolusVM server management services that won’t
              break the bank? We’ve got you covered! Our perfect SolusVM support
              plans are designed to meet the business needs of your hosting
              business.
            </p>
          </div>
        </div>
