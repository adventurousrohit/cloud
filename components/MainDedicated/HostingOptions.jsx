    ...
    <div className="container my-5 pt-20 pb-30">
      ...
      <div className="row g-5">
        <div className="col-xxl-6 col-lg-6 d-flex flex-column justify-content-center">
          <h2>OS Freedom: Experience Your Dedicated Server in India</h2>
          <p>
          Enjoy complete control with our Dedicated Server in India, offering full OS freedom for customized configurations and enhanced performance.
          </p>
        </div>
      ...
      <div className="row g-5 mt-5">
        <div className="col-xxl-6 col-lg-6 order-lg-2 d-flex flex-column justify-content-center">
          <h2>Future-Ready Dedicated Server with Your Choice of Panel</h2>
          <p>
          With its smooth interaction with your preferred cPanel, our Future-Ready Dedicated Server offers simple maintenance, scalability, and peak performance for the expansion of your website.
          </p>
        </div>
