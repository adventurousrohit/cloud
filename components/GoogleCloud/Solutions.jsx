...
import { googleServices } from '../../utils/data';
...
const Solutions = () => {
  ...
  const getServicesForTab = (category) =>
    googleServices?.filter((service) => service.category === category);
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-xxl-10 text-center">
            ...
            >
           Experience Unrivaled Uptime with Managed Google Cloud Services
            </h2>
            <p
              data-sal="slide-up"
              data-sal-duration="500"
              ...
              data-sal-easing="ease-in-out-sine"
            >
           Make your cloud journey as easy as possible while optimizing efficiency so you can better focus on fostering innovation and growing your business effectively and efficiently. For professional Google Cloud administration, put your trust in us!
            </p>
          </div>
        </div>
