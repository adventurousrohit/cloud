                ...
                <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xxl-10">
                        <div className="text-center" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            <h2 className="mb-2">Choose the Perfect Operating System for Your Linux GPU Server</h2>
                            <p className="mb-0  mx-auto">Choose your ideal OS for Linux GPU servers and enjoy seamless performance with advanced security, ensuring hassle-free hosting for your high-performance applications.</p>
                        </div>
                    </div>
                </div>
            </div>
