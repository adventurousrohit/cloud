...
const pricingData = [
  {
    id: 1,
    title: "Starter webminservers Management",
    // price: '₹ 360.00/mo*',
    features: [
  ...
  {
    id: 2,
    title: "Plus webminservers Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro webminservers Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Webmin Server Management Made Easy—Plans for Every Need
              </h2>
            </div>
            <p className="text-white text-center">
              Use our Webmin plans to streamline server administration. We offer
              adaptable, effective, and user-friendly solutions to keep your
              servers operating effectively without the bother, whether you're a
