      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-12">
            ...
            >
           Enhance Your Linux Dedicated Hosting Plan with Premium Control Panels
            </h2>
            <p className="mb-8 max-text-120">Effortlessly manage your website, domain, email, and database with our powerful control panel options. Choose from DirectAdmin, cPanel, or Webuzo to streamline administrative tasks and save valuable time with ease.</p>
          </div>
        </div>
