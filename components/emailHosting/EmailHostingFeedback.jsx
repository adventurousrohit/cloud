            ...
            <div className="row">
                <div className="col-12">
                    <div className="card rounded-4 border-0 position-unset">
                        <div className="card-body pt-60 pb-60 px-md-8">
                            <div className="pb-40">
                                <div className="container">
                                    <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
                                        ...
                                        <div className="col-md-6 col-xl-5">
                                            <p className="mb-0" data-sal="slide-up" data-sal-duration="500" data-sal-delay="400" data-sal-easing="ease-in-out-sine">
                                                Guarantee reliability for websites, apps or Servers. We deliver
                                                round-the-clock, for your fast
                            ...
                            <div className="pb-60" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                                <div className="container">
                                    <div className="row">
                                        <div className="col-12">
                                                            ...
                                                            <div className="feedback-3-slider__item">
                                                                <div className="card rounded-4">
                                                                    <div className="card-body text-center px-8 py-10">
                                                                        ...
                                                                        <p className="mb-0">
                                                                            "Our AI image solutions have exceeded our
...
export default EmailHostingFeedback
