...
import { debounce, handleScroll } from "../common/others/Scroller";
import { useEffect, useRef } from "react";
const EmailHostingNav = () => {
  ...
  return (
        ...
        <div className="container">
            <div className="row g-1">
                <div className="col-md-6">
                    <small className="d-block fw-medium text-center text-md-start">
                ...
                <div className="col-md-6">
                    <ul className="navbar-nav flex-row align-items-center justify-content-center justify-content-md-end gap-2">
                        <li className="nav-item">
                            <a className="nav-link p-1 fs-14 fw-medium" href="#">
                                My Accounts
                            </a>
                        </li>
                        <li className="nav-item">
    ...
    <nav className="navbar navbar-box navbar-expand-lg sticky-top">
...
export default EmailHostingNav
