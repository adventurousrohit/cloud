            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-8 col-xxl-10">
                ...
                >
                  <h2 className="mb-2">
                    {" "}
                    Choose the right Operating System for VPS hosting Windows
                    Server
                  </h2>
                  <p className="mb-0 max-text-70 mx-auto">
                    Choose the right OS for your VPS hosting Windows server.
                    Have absolute performance and enhanced security with the
                    best-suited OS for your Windows VPS for hassle-free and
                    optimized hosting.
                  </p>
                </div>
              </div>
            ...
            <div className="col-12">
              <div className="tab-content mt-6">
                <div className="row g-4 row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-6 justify-content-center">
                  {techPartnersOperatingSystem?.map((item, i) => (
                      ...
                      <div className="card shadow-sm h-100 hover-text-white">
                        <div className="card-body d-flex align-items-center gap-3">
                          <div className="w-12 h-12 d-flex justify-content-center align-items-center flex-shirnk-0">
                            ...
                            <i
                              className={`fab ${item?.imgSrc}`}
                              style={{ fontSize: "50px", color: item?.altText }}
                            ></i>
                          </div>
                          <h6 className="m-0 flex-grow-1 fs-16 fw-bold hover-text-white">
                            {item.title}
                          </h6>
                        </div>
                      </div>
