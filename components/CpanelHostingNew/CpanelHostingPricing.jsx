          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Choose Your Perfect cPanel Support Plan
              </h2>
            </div>
            <p className="text-white text-center">
              Explore our perfect and absolute cPanel Server Management plans,
              designed to streamline your hosting experience. Whether you need
              expert system administration, support, or comprehensive
              management, our services ensure seamless server performance and
              security.
            </p>
          </div>
        </div>
