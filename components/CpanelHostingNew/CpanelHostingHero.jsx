        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                <span className="text-success-new">cPanel </span>
                Server Management
              </h1>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                cPanel Server Management Services and cPanel System
                Administration Services from CloudMinister for an affordable
                monthly price.
              </p>
              <div
             ...
             <Link
              ...
              {/* <span className="d-block fs-14 text-white text-opacity-75 mt-2" data-sal="slide-up" data-sal-duration="1500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                ...
                <div className="col-lg-5 col-xl-6 text-lg-end">
                    <img src="/img/Cpanelh.png" alt="image" className="img-fluid" data-sal="fade" data-sal-duration="1500" data-sal-delay="300" data-sal-easing="ease-in-out-sine"/>
                </div>
            </div>
        </div>
      </section>
