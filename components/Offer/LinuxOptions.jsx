    ...
    <div className="container my-5 pt-20 pb-30">
      ...
      <div className="row g-5">
        <div className="col-xxl-6 col-lg-6 d-flex flex-column justify-content-center">
          <h2>Pick Your Operating System for Linux hosting</h2>
          <p>
          Enjoy complete flexibility by selecting the perfect operating system to optimize and customize your Linux VPS Hosting performance.
          </p>
        </div>
      ...
      <div className="row g-5 mt-5">
        <div className="col-xxl-6 col-lg-6 order-lg-2 d-flex flex-column justify-content-center">
          <h2>Pick the perfect control panel for Your Hosting</h2>
          <p>
          With multiple control panel options, you can personalize your hosting experience and manage your server with confidence.
          </p>
        </div>
