const pricingData = [
  {
    ...
    title: "Control Panel",
    data: [
      { name: "cPanel Solo Cloud (1 Account)", price: "₹ 2,000.00/mo" },
      { name: "cPanel WHM Metal Cloud", price: "₹ 2,000.00/mo" },
      { name: "cPanel Admin Cloud (Up to 5 Accounts)", price: "₹ 2,500.00/mo" },
      { name: "cPanel Pro Cloud (Up to 30 Accounts)", price: "₹ 4,200.00/mo" },
      { name: "cPanel Premier Cloud (Up to 100 Accounts)", price: "₹ 5,500.00/mo" },
      { name: "cPanel Premier Metal", price: "₹ 5,500.00/mo" }
    ]
