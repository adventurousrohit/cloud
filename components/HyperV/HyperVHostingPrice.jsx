...
const pricingData = [
  {
    id: 1,
    title: "Starter Hyper-V Management",
    // price: '₹ 360.00/mo*',
    features: [
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Discover the Perfect Hyper-V Server Management Plan Today
              </h2>
            </div>
            <p className="text-white text-center">
              Explore the plan details below and feel free to reach out—our team
              is here to guide you in selecting the ideal Hyper-V Server
