            ...
            <div className="container">
                <div className="row g-4 align-items-center">
                    <div className="col-lg-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                        <img src="/Middle/Google Workspace (1).png" alt="image" className="img-fluid"/>
                    </div>
                    <div className="col-lg-6">
                        <div className="ps-lg-8 pe-xxl-12">
                            ...
                            Secure Google Workspace Solutions for Your Business
                            </h3>
                            <p data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            Use Google Workspace to streamline your workflow! We provide top-notch solutions that suit your company's requirements, from simple email management to smooth communication tools.
                            </p>
                            <p className="mb-0" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            Increase productivity with professional Gmail, Drive, Meet, integration, setup, and support. Google Workspace can help your team accomplish more by making chores easier. Allow us to assist you in realizing its greatest potential.
                            </p>
                            <a   href="https://wa.me/+918233040013"
                             target="_blank" className="btn btn-primary btn-arrow btn-lg fs-14 fw-medium rounded mt-5">
                                <span className="btn-arrow__text">
                                 Order Google WorkSpace Management
