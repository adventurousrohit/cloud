        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                {" "}
                Navigating the Web Safely: Smart Tips for{" "}
                <span className="text-success-new">Cyber Security</span>
                {""}
              </h1>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Today, in the digital age, safety online is much more important
                than ever. Our full Cyber Security services protect your data,
                networks, and devices from malicious threats. Advanced
                encryption, real-time monitoring, and proactive defense
                strategies ensure your business and personal information are
                secure, so you can confidently move through the digital world.
              </p>
              <div
