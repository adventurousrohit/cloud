  ...
  const cardData = [
    {
      ...
      description:
        "We fine-tune essential services such as servers and applications to enhance security and overall efficiency.",
    },
    {
      imgSrc: '/img/privacy-policy.png',
      title: 'Unmatched Protection',
      description:
        "We provide high-performance security solutions by implementing state-of-the-art tools and technologies that protect your data against unauthorized access and breaches.",
    },
    {
      imgSrc: '/img/expert.png',
      title: 'Continuous Monitoring and Updates',
      description:
        "Our experts provide 24/7 monitoring, identifying and resolving issues proactively. Regular updates ensure that your systems are equipped with the latest security measures.",
    },
    {
      imgSrc: '/img/lean-management.png',
      title: 'Customized Security Solutions',
      description:
        "We tailor our cybersecurity services to your unique needs, offering scalable and flexible options to protect your infrastructure effectively.",
    },
  ];
      ...
      <div className="container">
        <div className="row align-items-start g-4">
          <div className="col-lg-5" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
            <h2 className="h3 mb-3">Cyber Confidence Starts with CloudMinister</h2>
            <p className="mb-8 max-text-68">Deactivation of Vulnerable Entry Points
Our services terminate redundant and insecure services to minimize potential threats and ensure that your systems are always secure.
</p>
