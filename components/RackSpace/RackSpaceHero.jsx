        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                <span className="text-success-new"> Rackspace Server </span>
                Management Services: A Solution for Your Server Needs
              </h1>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Cloudminister manage Rackspace, so you don't have to.
              </p>
              <div
