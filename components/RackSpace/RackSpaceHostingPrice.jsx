...
const pricingData = [
  {
    id: 1,
    title: "Starter Rackspace Management",
    // price: '₹ 360.00/mo*',
    features: [
  ...
  {
    id: 2,
    title: "Plus Rackspace Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro Rackspace Management",
    // price: '₹ 360.00/mo*',
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Our Best Rackspace Server Management Plans and Prices
              </h2>
            </div>
            <p className="text-white text-center">
              We are more than just a service provider; we are your partner in
              growth. Being a top server management company, we provide
              unparalleled dependability by fusing state-of-the-art equipment
              with years of technical expertise.
            </p>
          </div>
        </div>
      </div>
