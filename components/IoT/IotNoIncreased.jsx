                ...
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="ps-lg-8 pe-xxl-12">
                            ...
                            The Future is Connected: Explore IoT Solutions Today
                            </h3>
                            <p data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            Let your business evolve through the transformation with IoT solutions. These services enable the smarter decisions through connectivity between devices and the analysis of real-time data for your organization to simplify processes, boost productivity, and foster growth.
                            </p>
                            <p className="mb-0" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            Witness intelligent automation and insights empowering you to take control of this rapidly evolving digital landscape.
                            </p>
