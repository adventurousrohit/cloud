          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Choose the Best Customized Server Management Support Plans{" "}
              </h2>
            </div>
            <p className="text-white text-center">
              We at CloudMinister understand that every business has unique IT
              needs. Our customized server management support plans are designed
              to provide the best solutions to ensure your servers are secure,
              efficient, and always operational.
            </p>
          </div>
        </div>
      </div>
