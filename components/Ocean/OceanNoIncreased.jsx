        ...
        <div className="pb-60">
          <div className="container">
            <div className="row g-4 align-items-center">
              ...
              >
                <img
                  src="/server-managemnt-middle-image/DigitalOcean.png"
                  alt="DigitalOcean"
                  className="img-fluid"
                />
              </div>
              <div className="col-lg-6">
                <div className="ps-lg-8 pe-xxl-12">
                  ...
                  <h2
                    ...
                    data-sal-easing="ease-in-out-sine"
                  >
                    Simplify your DigitalOcean server management with
                    CloudMinister
                  </h2>
                  ...
                  <p
                    ...
                    data-sal-easing="ease-in-out-sine"
                  >
                    Experience unmatched server management with Digital Ocean,
                    the ultimate powerhouse for your site. Enjoy robust
                    security, reliable uptime, and expert support as your site
                    is in good hands. Let Digital Ocean power your vision while
                    we manage the rest—effortlessly and efficiently!
                  </p>
                  <a
                  ...
                  >
                    <span className="btn-arrow__text">
                      Order Digital Ocean Server Management
