...
const pricingData = [
  {
    id: 1,
    title: "Starter Ocean Management",
    // price: '₹ 360.00/mo*',
    features: [
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Affordable DigitalOcean Server Management Services : Choose a
                Plan
              </h2>
            </div>
            <p className="text-white text-center">
              Discover flexible cloud solutions designed to bring your
              innovative visions to life perfectly.
            </p>
          </div>
        </div>
      </div>
