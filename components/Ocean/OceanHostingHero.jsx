        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              >
                Expert <span className="text-success-new"> DigitalOcean </span>{" "}
                Server Management Services in India
              </h2>
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Whether you are a developer or a fast-growing business, Digital
                Ocean is the gateway to innovation, through its intuitive and
                robust features. Here is the simplicity and efficiency; your
                journey towards digital excellence begins here.
              </p>
              <div
