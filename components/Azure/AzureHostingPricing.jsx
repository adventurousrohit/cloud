...
const pricingData = [
  {
    id: 1,
    title: "Starter Microsoft Azure Management",
    // price: '₹ 360.00/mo*',
    features: [
  ...
  {
    id: 2,
    title: "Plus Microsoft Azure Management",
    // price: "₹ 360.00/mo*",
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
  ...
  {
    id: 3,
    title: "Pro Microsoft Azure Management",
    // price: "₹ 360.00/mo*",/contact
    features: [
      { feature: "Server hardware analysis", enabled: true },
      { feature: "Server software analysis", enabled: true },
      { feature: "Security Tweaks and Optimizations", enabled: true },
          ...
          <div className="row justify-content-center">
            ...
            >
              <h2 className="text-white">
                Power Up with Microsoft Azure Cloud Management Services – Plans
                with Budget-Friendly Prices!
              </h2>
            </div>
            <p className="text-white text-center">
              Boost efficiency with Microsoft Azure Cloud Management Services!
              Scalable, secure, and cost-effective plans absolutely cater to
              your business needs—maximize performance without breaking your
              budget. Power up your cloud journey today!
            </p>
          </div>
        </div>
      </div>
